...
import { Key, Lock, Book, User, Flower2, Loader2, AlertCircle } from 'lucide-react'
      ...
      <form onSubmit={handleRegister} className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="relative">
            <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground text-[var(--color-gold)]/50" />
            <input
              type="text"
              value={username}
